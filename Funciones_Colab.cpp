...
void listarColaboradores() {
    if (cant_colaboradores > 0) {
        ...
        for (int i = 0; i < cant_colaboradores; i++) {
            ...
            cout << "C贸digo: " << colaborador[i].codigo << endl;
            cout << "Tel茅fono: " << colaborador[i].telefono << endl;
            cout << endl;
        }
    } else {
...
void modificarColaborador() {
    ...
    int codigoBuscado;
    cout << "Ingrese el c贸digo del colaborador que desea modificar: ";
    cin>> codigoBuscado;
    cin.ignore();
    for (int i = 0; i < cant_colaboradores; i++) {
        if (colaborador[i].codigo == codigoBuscado) {
            ...
            cout << "Tel茅fono actual: " << colaborador[i].telefono << endl;
            string nuevoNombre, nuevoTelefono;
            int nuevaEdad;
            cout << "\nNuevo nombre (dejar vac铆o para mantener): ";
            getline(cin, nuevoNombre);
            if (!nuevoNombre.empty()) {
                colaborador[i].nombres = nuevoNombre;
            }
            cout << "Nuevo tel茅fono (dejar vac铆o para mantener): ";
    ...
    cout << "\n No se encontr贸 un colaborador con ese c贸digo." << endl;
}
...
if(cant_colaboradores>0){
	...
	cout<<"Ingrese el c贸digo de la persona "<<endl;
	cin>>cod;
...
void agregarColaborador() {
    if (cant_colaboradores >= maximo) {
        cout << "No se pueden agregar m谩s colaboradores (l铆mite alcanzado)." << endl;
        return;
    }
...
void agregarVenta(){
		...
		int codi;
        	cout<<"Ingrese su c贸digo de colaborador: "<<endl;
        	cin>>codi;
        	cin.ignore();
...
void rendimientoColaborador(){
	...
	cout<<"Ingrese el c贸digo del colaborador "<<endl;
	cin>>codig;
	cin.ignore();
 ...
 void productoMasCaroRegistrado() {
    ...
    if (encontrado) {
        ...
        cout << "Producto m谩s caro registrado:\n";
        ...
        cout << "A煤n no se ha registrado ninguna venta.\n";
    }
}
